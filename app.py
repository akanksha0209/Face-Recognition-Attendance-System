...
from forms import LoginForm, StudentForm, ClassAttendance, StudentAttendance, TeacherForm, \
    RemoveStudent, RemoveTeacher, VerifiedImage, RetakeImage
    ...
    def create_timetable(self):
        ...
        if len(create) == 0:
            ...
            c19 = TimeTable(branch='CSE', semester='3rd', day='4', period='3rd-period',
                            subject='DMS', teacher='Teacher4')
            c20 = TimeTable(branch='CSE', semester='3rd', day='4', period='4th-period',
                            subject='OS', teacher='Teacher2')
            ...
            e19 = TimeTable(branch='ECE', semester='3rd', day='4', period='3rd-period',
                            subject='AMC', teacher='Teacher9')
            e20 = TimeTable(branch='ECE', semester='3rd', day='4', period='4th-period',
                            subject='EF', teacher='Teacher7')
...
class StudentLogins(db.Model):
    ...
    def remove(self, student_id):
        remove_user = StudentLogins.query.filter_by(student_id=student_id).first()
...
def gen(camera):
    encode_list_known = camera.get_encodings()

    while True:
        image = camera.get_frame(encode_list_known)
...
class Camera(object):
    ...
    def find_encodings(self):  # gets face encodings
        encode_list_known = []
...
@app.route('/view_class_attendance', methods=["GET", "POST"])
