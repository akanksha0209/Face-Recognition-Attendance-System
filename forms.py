...
class StudentForm(FlaskForm):
    ...
    semester = StringField(label="Current semester(eg.3rd)", validators=[DataRequired()])
    branch = StringField(label="Branch(eg.CSE)", validators=[DataRequired()])
...
class ClassAttendance(FlaskForm):
    ...
    year = StringField(label='Which semester(eg.3rd)', validators=[DataRequired()])
    branch = StringField(label='Branch(eg.CSE)', validators=[DataRequired()])
...
class TeacherForm(FlaskForm):
    ...
    semester = StringField(label='For which semester are you teaching the above subject(eg.3rd)',
                           validators=[DataRequired()])
    branch = StringField(label="Branch(eg.CSE)", validators=[DataRequired()])
    submit = SubmitField(label='Register')
